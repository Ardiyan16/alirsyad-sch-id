						...
						<div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
									<form action="<?= base_url('Admin/simpan_berita') ?>" method="post" enctype="multipart/form-data">
										<div class="form-row">
											<div class="form-group col-md-12">
												<label>Judul <span class="text-danger">*</span></label>
												<input type="text" class="form-control" name="title" id="title" value="<?= set_value('title') ?>" onkeyup="createTextSlug()">
												<?= form_error('title', '<small class="text-danger pl-3">', '</small>'); ?>
											</div>
											<div class="form-group col-md-12">
												<label>Slug <span class="text-danger">*</span></label>
												<input type="text" class="form-control" name="slug" id="slug" readonly value="<?= set_value('slug') ?>">
												<?= form_error('slug', '<small class="text-danger pl-3">', '</small>'); ?>
											</div>
											<div class="form-group col-md-12">
												<label>Tanggal <span class="text-danger">*</span></label>
												<input type="date" class="form-control col-md-2" name="date" value="<?= set_value('date') ?>">
												<?= form_error('date', '<small class="text-danger pl-3">', '</small>'); ?>
											</div>
											<div class="form-group col-md-12">
												<label>Penulis <span class="text-danger">*</span></label>
												<input type="text" class="form-control" name="writer" value="<?= set_value('writer') ?>">
												<?= form_error('writer', '<small class="text-danger pl-3">', '</small>'); ?>
											</div>
											<div class="form-group col-md-12">
												<label>Isi Berita <span class="text-danger">*</span></label>
												<textarea type="text" name="content" class="summernote"><?= set_value('content') ?></textarea>
